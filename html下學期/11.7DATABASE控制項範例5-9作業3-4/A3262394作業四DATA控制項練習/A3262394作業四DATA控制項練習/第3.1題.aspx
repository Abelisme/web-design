<%@ Page Language="C#" AutoEventWireup="true" CodeFile="第3.1題.aspx.cs" Inherits="第3_1題" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="編號" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" OnPageIndexChanged="GridView1_PageIndexChanged">
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="網址" DataTextField="網址" HeaderText="網址" Target="_blank" />
            </Columns>
